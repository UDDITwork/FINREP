// Location: frontend/src/components/meetings/TranscriptViewer.jsx
...
Generated by Richie AI Meeting System`;
  ...
  const getVTTDownloadLink = async () => {
    try {
      ...
      if (response.downloadLink) {
        ...
        setError('VTT download link not available for this meeting');
      }
    } catch (error) {
      console.error('Failed to get VTT download link:', error);
      setError('Failed to get VTT download link. Please try fetching transcript first.');
    } finally {
      ...
      <div className="bg-white rounded-lg max-w-4xl w-full max-h-[90vh] flex flex-col">
        ...
        <div className="p-6 border-b border-gray-200">
          <div className="flex items-center justify-between">
            ...
            {/* ⭐ REPLACE THIS SECTION WITH BOTH BUTTONS */}
            <div className="flex items-center gap-2">
              {/* VTT Download Button */}
              <button
                onClick={getVTTDownloadLink}
                disabled={isGettingDownloadLink}
                className="px-3 py-2 bg-green-600 text-white rounded hover:bg-green-700 disabled:bg-gray-400 flex items-center gap-2"
                title="Download original VTT file from Daily.co"
              >
