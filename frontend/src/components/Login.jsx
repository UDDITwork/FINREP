/**
 * FILE LOCATION: frontend/src/components/Login.jsx
 * 
 * User authentication login component that handles advisor login functionality.
 * Includes form validation, authentication state management, and integration
 * with the authentication context for user login and session management.
      ...
      <div className="max-w-md w-full relative z-20">
        <div className="bg-white/10 backdrop-blur-lg px-8 py-10 rounded-2xl shadow-2xl border border-white/20 hover:bg-white/15 transition-all duration-300">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-100 text-base drop-shadow-md">Sign in to your Richie AI account</p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                ...
                <Link to="/forgot-password" className="text-sm text-blue-100 hover:text-white transition duration-200 drop-shadow-sm">
                  Forgot password?
                </Link>
              </div>
            ...
            <div className="flex items-center">
              <input
                ...
                type="checkbox"
                {...register('rememberMe')}
                className="h-4 w-4 text-emerald-600 focus:ring-emerald-500 border-white/30 rounded transition duration-200 bg-white/20 backdrop-blur-sm"
              />
              <label htmlFor="remember-me" className="ml-3 block text-sm text-white drop-shadow-sm">
                Remember me
              </label>
            </div>
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-transparent text-gray-100 drop-shadow-md">Or continue with</span>
              </div>
            </div>
            ...
            <div className="text-center pt-2">
              <span className="text-sm text-gray-100 drop-shadow-sm">
                ...
                <Link to="/signup" className="font-medium text-blue-100 hover:text-white transition duration-200 drop-shadow-sm">
                  Sign up here
                </Link>
              </span>
            </div>
