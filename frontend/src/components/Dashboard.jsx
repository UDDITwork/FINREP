          ...
          <div className="max-w-2xl mx-auto">
            ...
            <div className="relative search-container">
              <div className="relative">
                ...
                <input
                  type="text"
                  placeholder="Type company name (e.g., Reliance, TCS, HDFC)..."
                        ...
                        >
                          <div className="flex items-center space-x-3">
                            ...
                            <div className="flex-1">
                              ...
                              <div className="text-sm text-gray-500">{suggestion.symbol}</div>
                            </div>
      ...
      <div className="mb-6 sm:mb-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <ActionCard
            ...
            description="Search stocks, mutual funds, and IPOs"
            buttonText="Search"
          ...
          <ActionCard
            ...
            description="Stay updated with latest market news"
