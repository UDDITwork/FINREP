/**
 * FILE LOCATION: frontend/src/components/Signup.jsx
 * 
 * User registration component that handles new advisor account creation.
 * Includes form validation, user data collection, and integration with
 * the authentication system for new user registration and onboarding.
 */
